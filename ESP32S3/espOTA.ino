...
// =================================================================================================
const char* serverIP      = "10.187.28.26"; 

const char* ssid          = "QiQi";
const char* password      = "hongchoa";
...
void loop() {
  ...
  if (doorStateChanged) {
    ...
    // Nếu cửa đóng lại sau khi mở bằng xác thực hợp lệ: khóa an ninh ngay lập tức
    if (!isDoorOpen && isAuthenticated) {
